...
export const allprojects = [
    ...
    // 6 title: "Nike Shoes Website",
    {
        ...
        date: "Feb 2024 - Mar 2024",
        description: "Developed an e-commerce Nike shoe store with integrated contact support. Utilized React.js and JavaScript for front-end development. Implemented Tailwind CSS for modern and efficient styling",
        image: Nike_Shoe,
    ...
    // 7. title: "Weather Tracking Web App",
    {
        ...
        date: "Feb 2024 - Mar 2024",
        description: "Created a user-friendly interface using HTML and CSS for smooth experience. Used advanced Js techniques to dynamically update information. Mastered fetch API's integration, combining with Js skills to build an interactive Weather Tracker Web App.",
    ...
    // 8. title: "Razorpay Clone",
    {
        ...
        date: "Jan 2024 - Feb 2024",
        description: "Successfully replicated Razorpay's clone using HTML, CSS, and Tailwind CSS. Ensured a smooth user experience by implementing a responsive website design, making the Razorpay clone accessible across various devices.",
    ...
    // 9. title: "E-commerce Shopping Website",
    {
        ...
        description: "Built an E-commerce shopping website using HTML, CSS, and JavaScript. Implemented a product catalogue, shopping cart, blog site, about, services and checkout process. Made the website responsive for mobile-friendly and any device.",
    ...
    // 10. title: "Password Generator WebApp",
    {
        ...
        date: "Feb 2024 - Mar 2024",
        description: "Built a strong Password Generator with HTML, CSS, and JavaScript for reliable and secure password creation. Used javaScript, core concepts like methods, properties, and attributes.",
    ...
    // 11. title: "Basice Portfolio",
    {
        ...
        description: "Built a portfolio website to showcase web development skills. Constantly updated website with new projects to track my progress and improve relevant skills. Learned about the importance of design and usability.",
    ...
    // 12. title: "Client Portfolio Website",
    {
        ...
        date: "Aug 2023 - Sep 2023",
        description: "Designed and developed a professional Portfolio website to showcase skills, projects, and achievements. Created an attractive and user-friendly interface to engage potential employers.",
    ...
    // 13. title: "Spotify Clones Website",
    {
        ...
        date: "Aug 2023 - Sep 2023",
        description: "Developed a responsive music streaming website using HTML, CSS, and JavaScript, replicating the user interface of Spotify. Created a visually appealing and user-friendly design, ensuring seamless navigation and ease of use.",
        image: Spotify_clone,
    ...
    // 14. title: "Login Page",
    {
        ...
        title: "Login Page",
        date: "Aug 2023 - Sep 2023",
        description: "Our project focuses on creating a user-friendly login page for our website. It provides a secure and streamlined login process, allowing users to access their personalized accounts with ease.",
        image: Login_Page,
